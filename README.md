...
Inspired from [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,763 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 and [clean-code-php](https://github.com/jupeter/clean-code-php) ⭐ 12,447 | 🐛 30 | 🌐 PHP | 📅 2024-05-09 lists.
...
* [clean-code-typescript](https://github.com/labs42io/clean-code-typescript) ⭐ 9,811 | 🐛 3 | 🌐 TypeScript | 📅 2025-07-01 - Clean Code concepts adapted for TypeScript
...
* [clean-abap](https://github.com/SAP/styleguides) ⭐ 2,006 | 🐛 79 | 🌐 Markdown | 📅 2026-04-02 - Clean Code concepts adapted for ABAP
* [clean-code-ruby](https://github.com/uohzxela/clean-code-ruby) ⭐ 1,596 | 🐛 7 | 🌐 Ruby | 📅 2022-09-10 - Clean Code concepts adapted for Ruby
* [Elixir-Code-Smells](https://github.com/lucasvegi/Elixir-Code-Smells) ⭐ 1,516 | 🐛 1 | 🌐 Elixir | 📅 2024-09-12 - Catalog of Elixir-specific code smells
...
* [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,614 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15 - The Node.js best practices list
* [Google Styleguides](https://github.com/google/styleguide) ⭐ 39,602 | 🐛 170 | 🌐 HTML | 📅 2026-09-13 - This project holds the C++ Style Guide, Swift Style Guide, Objective-C Style Guide, Java Style Guide, Python Style Guide, R Style Guide, Shell Style Guide, HTML/CSS Style Guide, JavaScript Style Guide, AngularJS Style Guide, Common Lisp Style Guide, and Vimscript Style Guide
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,290 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Django styleguide used in HackSoft projects

## Tools

* [codemaid](https://github.com/codecadwallader/codemaid) ⭐ 1,987 | 🐛 507 | 🌐 C# | 📅 2025-10-13 - open source Visual Studio extension to cleanup and simplify our C#, C++, F#, VB, PHP, PowerShell, JSON, XAML, XML, ASP, HTML, CSS, LESS, SCSS, JavaScript and TypeScript coding
...
* [Modern JavaScript Cheatsheet](https://github.com/mbeaudru/modern-js-cheatsheet) ⭐ 25,604 | 🐛 10 | 📅 2024-10-15 - Cheatsheet for the JavaScript knowledge you will frequently encounter in modern projects
...
* [Cognitive Load In Software Development](https://github.com/zakirullin/cognitive-load) ⭐ 12,505 | 🐛 23 | 📅 2026-06-29
