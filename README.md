...
* [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,533 | 🐛 136 | 🌐 Dockerfile | 📅 2026-06-15 - The Node.js best practices list
* [Google Styleguides](https://github.com/google/styleguide) ⭐ 39,505 | 🐛 169 | 🌐 HTML | 📅 2026-06-03 - This project holds the C++ Style Guide, Swift Style Guide, Objective-C Style Guide, Java Style Guide, Python Style Guide, R Style Guide, Shell Style Guide, HTML/CSS Style Guide, JavaScript Style Guide, AngularJS Style Guide, Common Lisp Style Guide, and Vimscript Style Guide
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,271 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Django styleguide used in HackSoft projects
...
* [naming-cheatsheet](https://github.com/kettanaito/naming-cheatsheet) ⭐ 14,184 | 🐛 21 | 📅 2024-03-13 - Comprehensive language-agnostic guidelines on variables naming
* [Cognitive Load In Software Development](https://github.com/zakirullin/cognitive-load) ⭐ 12,481 | 🐛 23 | 📅 2026-06-29
* [AspNetCoreDiagnosticScenarios](https://github.com/davidfowl/AspNetCoreDiagnosticScenarios) ⭐ 8,512 | 🐛 27 | 🌐 C# | 📅 2024-05-28 - Examples of broken patterns in ASP.NET Core applications
