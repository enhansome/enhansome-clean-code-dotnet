...
Inspired from [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,761 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 and [clean-code-php](https://github.com/jupeter/clean-code-php) ⭐ 12,447 | 🐛 30 | 🌐 PHP | 📅 2024-05-09 lists.
...
* [clean-code-php](https://github.com/jupeter/clean-code-php) ⭐ 12,447 | 🐛 30 | 🌐 PHP | 📅 2024-05-09 - Clean Code concepts adapted for PHP
* [clean-code-typescript](https://github.com/labs42io/clean-code-typescript) ⭐ 9,819 | 🐛 3 | 🌐 TypeScript | 📅 2025-07-01 - Clean Code concepts adapted for TypeScript
...
* [clean-go-article](https://github.com/Pungyeon/clean-go-article) ⭐ 3,089 | 🐛 8 | 📅 2023-01-31 - Clean Code concepts adapted for Golang and an example how to apply [clean code in Golang](https://github.com/Pungyeon/clean-go) ⭐ 141 | 🐛 0 | 🌐 Go | 📅 2020-02-03
* [clean-abap](https://github.com/SAP/styleguides) ⭐ 2,012 | 🐛 79 | 🌐 Markdown | 📅 2026-04-02 - Clean Code concepts adapted for ABAP
...
* [awesome-clean-code](https://github.com/kkisiele/awesome-clean-code) ⭐ 122 | 🐛 0 | 📅 2023-03-20 - Design principles, featured articles, tutorials, videos, code examples, blogs and books

## Style Guides

* [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,628 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15 - The Node.js best practices list
* [Google Styleguides](https://github.com/google/styleguide) ⭐ 39,616 | 🐛 170 | 🌐 HTML | 📅 2026-09-18 - This project holds the C++ Style Guide, Swift Style Guide, Objective-C Style Guide, Java Style Guide, Python Style Guide, R Style Guide, Shell Style Guide, HTML/CSS Style Guide, JavaScript Style Guide, AngularJS Style Guide, Common Lisp Style Guide, and Vimscript Style Guide
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,291 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Django styleguide used in HackSoft projects

## Tools

* [codemaid](https://github.com/codecadwallader/codemaid) ⭐ 1,988 | 🐛 507 | 🌐 C# | 📅 2025-10-13 - open source Visual Studio extension to cleanup and simplify our C#, C++, F#, VB, PHP, PowerShell, JSON, XAML, XML, ASP, HTML, CSS, LESS, SCSS, JavaScript and TypeScript coding
...
* [Modern JavaScript Cheatsheet](https://github.com/mbeaudru/modern-js-cheatsheet) ⭐ 25,602 | 🐛 10 | 📅 2024-10-15 - Cheatsheet for the JavaScript knowledge you will frequently encounter in modern projects
* [naming-cheatsheet](https://github.com/kettanaito/naming-cheatsheet) ⭐ 14,192 | 🐛 21 | 📅 2024-03-13 - Comprehensive language-agnostic guidelines on variables naming
* [Cognitive Load In Software Development](https://github.com/zakirullin/cognitive-load) ⭐ 12,507 | 🐛 23 | 📅 2026-06-29
...
[<img src="https://opencollective.com/cleancodedotnet/contributors.svg?width=890" title="contributors" alt="contributors" />](https://github.com/thangchung/clean-code-dotnet/graphs/contributors) ⭐ 7,736 | 🐛 47 | 🌐 C# | 📅 2026-02-27
