...
Inspired from [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,753 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 and [clean-code-php](https://github.com/jupeter/clean-code-php) ⭐ 12,446 | 🐛 30 | 🌐 PHP | 📅 2024-05-09 lists.
...
* [clean-code-typescript](https://github.com/labs42io/clean-code-typescript) ⭐ 9,816 | 🐛 3 | 🌐 TypeScript | 📅 2025-07-01 - Clean Code concepts adapted for TypeScript
...
* [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,634 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15 - The Node.js best practices list
* [Google Styleguides](https://github.com/google/styleguide) ⭐ 39,626 | 🐛 170 | 🌐 HTML | 📅 2026-09-21 - This project holds the C++ Style Guide, Swift Style Guide, Objective-C Style Guide, Java Style Guide, Python Style Guide, R Style Guide, Shell Style Guide, HTML/CSS Style Guide, JavaScript Style Guide, AngularJS Style Guide, Common Lisp Style Guide, and Vimscript Style Guide
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,293 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Django styleguide used in HackSoft projects
...
* [Cognitive Load In Software Development](https://github.com/zakirullin/cognitive-load) ⭐ 12,509 | 🐛 23 | 📅 2026-06-29
